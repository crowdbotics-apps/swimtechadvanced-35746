...
## Project Structure
    ...
    ├── swimtechadvanced_35746  # Django project configurations
...
1. Clone this repo and `cd swimtechadvanced_35746`
...
2. Clone this repo and `cd swimtechadvanced_35746`
